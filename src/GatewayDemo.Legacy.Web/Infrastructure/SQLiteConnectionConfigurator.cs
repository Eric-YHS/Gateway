...
namespace GatewayDemo.Legacy.Web.Infrastructure
{
    internal static class SQLiteConnectionConfigurator
    {
        ...
        {
            ConfigureOpenConnection(connection, null);
        }

        public static void ConfigureOpenConnection(SQLiteConnection connection, int? busyTimeoutMilliseconds)
        {
...
PRAGMA busy_timeout = " + (busyTimeoutMilliseconds.HasValue ? busyTimeoutMilliseconds.Value.ToString() : BusyTimeoutMilliseconds.ToString()) + @";
