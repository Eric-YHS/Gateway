    ...
    public sealed class DeviceCredentialService
    {
        ...
        private LegacyAppRequestDescriptor BuildLegacyAppRequestDescriptor(HttpContext context)
        {
            ...
            descriptor.CompanyName = FirstNonEmpty(
                ...
                tenantName,
                dataCenterId,
                NormalizeUrlHost(urlBefore),
                request.Url == null ? string.Empty : request.Url.GetLeftPart(UriPartial.Authority));
            ...
            {
                descriptor.CompanyName = request.Url == null ? profile.AutoRequestApplicantName : request.Url.Host;
            }
